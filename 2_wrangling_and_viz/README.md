...
Before class, it is recommended to skim through the [online session notes](https://philchodrow.github.io/cos_2018/2_wrangling_and_viz/S2_master.html).
...
(The `S2_master.Rmd` and `S2_master.html` files creating the [online session notes](https://philchodrow.github.io/cos_2018/2_wrangling_and_viz/S2_master.html) can be ignored.)
