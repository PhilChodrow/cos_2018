...
#' 
## ------------------------------------------------------------------------
listings %>% summarise(price = mean(price))
...
#' 
#' Hint: `cut(x, breaks = quantile(x))` takes a numeric vector `x`, and returns a vector of labels indicating which quartile each element of `x` falls into.
#' 
#' *ANSWER:*
## ----exercise-1-1--------------------------------------------------------
listings %>%
