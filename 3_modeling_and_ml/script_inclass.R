...
results <- data.frame(model = "original", R2 = R2,
...
# As one set of predictors, the column listings$amenities
# looks interesting: ->
...
# to translate a string into a formula.	Here the code is provided,
...
# Note that R recognizes this by giving warnings about a
# "rank-deficient fit."	
...
# What does the model object look like?	
...
# View the first few data frame columns.  Note that column names
# corresponding to word frequencies are lowercase, while all other
# column names are uppercase. Up to here, we have just pre-processed
# and prepared our data. Now, we are ready to build models.
